...
def get_word_score(word, n):
    ...
    word_points = word_len*letter_points
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while (hand_len > 0 and word != '.'):

        valid_word = False

        while(not(valid_word) and word != '.'):
...
or an 'e' if you want to exit the game: ")
        ...
        #Otherwise, previous hand is an option
            ...
            while(not(valid_choice)):            
                ...
                choice = raw_input("Input an 'n' if you want to play a new hand,\n \
an 'r' if you want to play the last hand again, \n \
or an 'e' if you want to exit the game: ")
